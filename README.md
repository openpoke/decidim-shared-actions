...
- **Build and push docker image**
  This action builds the docker image and pushed it to the registry passed as input (with `ghcr.io` as default). The image will be available as `organization/repositroy-name:branch` inside the selected registry.
